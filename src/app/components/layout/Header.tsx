...
const MobileNavItem = ({ href, icon, children }: { href: string; icon: string; children: React.ReactNode }) => {
  ...
  // Updated: Active state uses a subtle gray background and high-contrast text
  ...
  // Updated: Inactive state uses neutral gray tones
...
export default function Header() {
  ...
  // Updated: Header background is now a light gray and a dark neutral color
        ...
        <nav className="container mx-auto flex h-20 items-center justify-between px-6">
          ...
          <div className="hidden lg:flex items-center">
            <ul className="flex items-center gap-8">
              {/* Updated: Active link is now high-contrast black/white with a gray border */}
              ...
              <li className="group">
                ...
                {/* Updated: Mega menu uses neutral gray backgrounds */}
                      ...
                      <div>
                        ...
                        <ul className="grid grid-cols-2 gap-x-6 gap-y-3">
                          {otherCategories.map((cat) => (
                            <li key={cat.id}>
                              {/* Updated: Mega menu link text and hover colors */}
